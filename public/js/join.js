 let join_check = document.querySelector('#join_check');

    function Validation(){
        var RegExp = /^[a-zA-Z0-9]{4,12}$/; //id와 pwassword 유효성 검사 정규식. a~z까지 사용 가능하다. 문자는 4~12개까지 사용 가능하다.
        //이메일 유효성검사
        var e_RegExp = /^[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]{2,3}$/i;
        var n_RegExp = /^[가-힣]{2,15}$/; //이름 유효성검사 정규식. 가부터 힣까지 가능.
    ...
    join_check.addEventListener("click",Validation);